...
// function createMovieSection(title, imageurl, gname, release, description, dname)
...
//   movieGenre.innerHTML= `Genre: ${gname}`;
//   movieInfoContainer.appendChild(movieGenre);

//   let movieRelease= document.createElement('h3');
//   movieRelease.innerHTML= `Release date: ${release}`;
//   movieInfoContainer.appendChild(movieRelease);

//   let movieDescription= document.createElement('p');
//   movieDescription.innerHTML= description;
//   movieInfoContainer.appendChild(movieDescription);

//   let movieDirector= document.createElement('h4');
//   movieDirector.innerHTML= `Director: ${dname}`;
...
//   createMovieSection(movie.title, movie.imageurl, movie.genre.name, movie.release, movie.description, movie.director.name);
...

{
  ...
  let movieGenre= document.createElement('h1');
  movieGenre.innerHTML= `Genre: ${movie.genre.name}`;
  movieInfoContainer.appendChild(movieGenre);

  let movieRelease= document.createElement('h3');
  movieRelease.innerHTML= `Release date: ${movie.release}`;
  movieInfoContainer.appendChild(movieRelease);
  ...
  let movieDirector= document.createElement('h4');
  movieDirector.innerHTML= `Director: ${movie.director.name}`;
  movieInfoContainer.appendChild(movieDirector);
